...
export default function DeliveryEditInfo() {
        ...
        <div>
            ...
            >
                <Box sx={style}>
                    ...
                    <BoxHeading>
                        <Typography1>Delivery To</Typography1>
                    ...
                    <Box className='deliveryForm'>
                        ...
                        <div style={{ display: "flex", marginTop: "-15px" }}>
                            ...
                            <div className='infoInput'>
                                <label>Shipment Type</label> <br></br>
                                <select>
                                    <option>Shipment1</option>
                                    <option>Shipment2</option>
                                </select>
                            </div>
                        </div>
