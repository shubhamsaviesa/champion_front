...
import LowStockTable from './Table/LowStockTable'
            ...
            <div className='backgroundcontainer'>
                <div className='headingbaronaction'>
                    <div className='toptableheading'>
                        ...
                        <div className='subtoptableheadingone'>
                            <span>Reports</span> <span><MdOutlineArrowForwardIos /></span><span className='subMenu_subheading'>Sales Report By Low in stock</span>
                        </div>
                    </div>
                </div>
