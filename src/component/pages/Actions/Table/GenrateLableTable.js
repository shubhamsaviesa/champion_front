...
import { GenerateLableColoumn } from "./GenerateLableColoumn";
import { Checkbox } from "./Checkbox";
import { GlobalFilter } from "./GenerateLableFilter";
...
const GenrateLableTable = () => {
  const columns = useMemo(() => GenerateLableColoumn, []);
                ...
                <div>
                  <div className="form-group">
                    ...
                    <select
                      ...
                      style={{ width: "0px", webkitAppearance: "none" }}
                    >
...
export default GenrateLableTable;
