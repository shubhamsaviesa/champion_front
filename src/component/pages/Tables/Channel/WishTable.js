...
const WishTable = () => {
    ...
    const [channelname,setChannelname] = useState("Wish")
    ...
    if(sidenavbar){
        ...
        <>
        <div classNameName={ChanelTable.maincontainer}>
            <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} channelname={channelname}/>
           <div classNameName={ChanelTable.actionbuttonintable}>
               <div>
                 <div classNameName={ChanelTable.headinglistingintable}>Listings</div>
               </div>
           ...
           <table classNameName={ChanelTable.Channeltable} {...getTableProps()}>
                   <thead>
           ...
           <table classNameName={ChanelTable.forPagination}>
            
               <tbody >
                 <tr>
                 <div classNameName='bottamcontainer'>
               <div classNameName="exportboxcontainer">
                   <div>
       
                   </div>
               </div>
               <div classNameName={ChanelTable.paginationcontainer}>
        ...
        <>
        <div classNameName={ChanelTable.maincontainer}>
        <div classNameName={ChanelTable.maincontainer2}>
             <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} channelname={channelname}/>
           <div classNameName={ChanelTable.actionbuttonintable}>
               <div>
                 <div classNameName={ChanelTable.headinglistingintable}>Listings</div>
