...
const BigCommerceTable = () => {
        ...
        <div className={ChanelTable.maincontainer}>
          ...
          <div className={ChanelTable.actionbuttonintable}>
            ...
            <div className={ChanelTable.dropdownnintable}>
              <select
                className={ChanelTable.dropdown_menu}
                name="cars"
                id="cars"
              >
      ...
      <>
        <div className={ChanelTable.maincontainer}>
          <div className={ChanelTable.maincontainer2}>
            ...
            <div className={ChanelTable.actionbuttonintable}>
              <div>
                <div className={ChanelTable.headinglistingintable}>
                  Listings
                </div>
              </div>
              <div className={ChanelTable.dropdownnintable}>
  ...
  return <>{ChannelConnectsTablerender}</>;
};

export default BigCommerceTable;
